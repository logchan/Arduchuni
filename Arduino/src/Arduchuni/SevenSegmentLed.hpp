...
/*
    ...
    4 |  | 2
       --  3
*/
template <int N> class SevenSegmentLed {
public:
  int numberData[10] = {0b0111111, 0b0000110, 0b1011011, 0b1001111, 0b1100110,
  ...
  void setDigit(int digit, int data) { m_data[digit] = data; }

  void setEmpty(int digit) { setDigit(digit, 0); }

  void setNumber(int digit, int n) { setDigit(digit, numberData[n]); }
